...
export const Drawer = ({ open, onClose, children, width = 480, className }: DrawerProps) => {
  ...
  return (
    <AriaModalOverlay
      ...
      className="fixed inset-0 z-[600] flex items-stretch justify-end bg-overlay/50 backdrop-blur-sm data-[entering]:animate-in data-[entering]:fade-in data-[exiting]:animate-out data-[exiting]:fade-out duration-200"
    >
      <AriaModal
        style={{ width }}
        className={cx(
