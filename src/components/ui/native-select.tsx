  ...
  return (
    <div className={cx('relative', wrapperClassName)}>
      <select
        {...props}
        className={cx(
          'w-full appearance-none rounded-lg border border-secondary bg-primary pl-3 pr-8 py-2 text-base text-primary outline-none focus:ring-2 focus:ring-brand-300',
          className
        )}
      >
        {children}
