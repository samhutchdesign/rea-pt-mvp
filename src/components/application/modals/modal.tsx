...
export const ModalOverlay = (props: AriaModalOverlayProps) => {
    return (
        <AriaModalOverlay
            ...
            className={(state) =>
                cx(
                    "fixed inset-0 z-[600] flex min-h-dvh w-full items-end justify-center bg-overlay/70 px-4 outline-hidden backdrop-blur-[6px] sm:items-center sm:justify-center sm:px-8",
                    // Vertical padding
...
export const Modal = (props: AriaModalOverlayProps) => (
    <AriaModal
        ...
        className={(state) =>
            cx(
                "rounded-lg bg-primary align-middle shadow-[0px_0px_5px_rgba(0,0,0,0.07)] outline-hidden max-sm:overflow-y-auto",
