...
export const styles = sortCx({
    ...
    sizes: {
        xs: {
            root: [
                "gap-1 rounded-full px-2.5 py-1.5 text-sm font-normal before:rounded-full data-icon-only:p-2",
        ...
        sm: {
            root: [
                "gap-1 rounded-full px-3 py-2 text-sm font-normal before:rounded-full data-icon-only:p-2",
                "in-data-input-wrapper:px-3.5 in-data-input-wrapper:py-2.5 in-data-input-wrapper:data-icon-only:p-2.5",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-3",
        },
        md: {
            root: [
                "gap-1 rounded-full px-3.5 py-2.5 text-sm font-normal before:rounded-full data-icon-only:p-2.5",
                "in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3",
            ].join(" "),
            linkRoot: "gap-1 *:data-text:underline-offset-4",
        },
        lg: {
            root: "gap-2 rounded-full px-4 py-2.5 text-md font-normal before:rounded-full data-icon-only:p-3 *:data-icon:size-6",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
        xl: {
            root: "gap-2 rounded-full px-4.5 py-3 text-md font-normal before:rounded-full data-icon-only:p-3.5 *:data-icon:size-6",
            linkRoot: "gap-1.5 *:data-text:underline-offset-4",
        },
    },
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-primary text-primary ring-1 ring-primary ring-inset hover:bg-primary_hover data-loading:bg-primary_hover",
