        ...
        <div className={cx("w-full in-data-input-wrapper:w-max", className)}>
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        "appearance-none rounded-lg bg-primary font-medium text-primary ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset placeholder:text-fg-quaternary focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50",
