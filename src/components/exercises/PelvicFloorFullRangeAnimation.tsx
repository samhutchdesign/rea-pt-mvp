...
export function PelvicFloorFullRangeAnimation({ holdSecs, restSecs, reps, className }: PelvicFloorFullRangeAnimationProps) {
  const phases: Phase[] = [
    { label: 'Contract', scale: SHRINK_SCALE, riseFraction: 1, durationMs: 900 },
    { label: 'Hold', scale: SHRINK_SCALE, riseFraction: 1, durationMs: Math.max(holdSecs, 0.1) * 1000 },
    { label: 'Release', scale: 1, riseFraction: 0, durationMs: 900 },
  ...
  return (
    <PelvicFloorCircleVisual scale={phase.scale} riseFraction={phase.riseFraction} className={className}>
